...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#141313]">
      ...
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#141313] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen ? 'left-0' : '-left-full'}`}>
        <img src={logo} alt="logo" className="w-full h-14 object-contain" />
